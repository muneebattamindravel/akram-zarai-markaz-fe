...
static public class WeaponXIMath
{
    ...
    //    if (!considerInactive && !WeaponXITools.GetActive(content.gameObject)) return;
    ...
    //    Camera cam = WeaponXITools.FindCameraForLayer(layer);
    ...
    //{
    //    Camera myCam = WeaponXITools.FindCameraForLayer(trans.gameObject.layer);
    ...
    //{
    //    Camera myCam = WeaponXITools.FindCameraForLayer(trans.gameObject.layer);
    //    Camera worldCam = WeaponXITools.FindCameraForLayer(target.gameObject.layer);
