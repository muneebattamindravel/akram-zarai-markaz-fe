...
namespace Crosstales.FB.EditorIntegration
{
   ...
   {
      [MenuItem("GameObject/" + Util.Constants.ASSET_NAME + "/PlatformWrapper", false, EditorHelper.GO_ID + 2)]
      ...
      [MenuItem("GameObject/" + Util.Constants.ASSET_NAME + "/PlatformWrapper", true)]
