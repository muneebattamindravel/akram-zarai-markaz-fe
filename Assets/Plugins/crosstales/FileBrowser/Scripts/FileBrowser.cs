   ...
   public class FileBrowser : Crosstales.Common.Util.Singleton<FileBrowser>
   {
      ...
      public string OpenSingleFile(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canOpenFile)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenSingleFile(string.IsNullOrEmpty(title) ? titleOpenFile : title, Util.Helper.ValidatePath(directory, true, false), defaultName, extensions);
      ...
      public string[] OpenFiles(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canOpenFile)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFiles(string.IsNullOrEmpty(title) ? titleOpenFiles : title, Util.Helper.ValidatePath(directory, true, false), defaultName, true, extensions);
      ...
      public string OpenSingleFolder(string title, string directory = "")
      {
         ...
         if (canOpenFolder)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenSingleFolder(string.IsNullOrEmpty(title) ? titleOpenFolder : title, Util.Helper.ValidatePath(directory, true, false));
      ...
      public string[] OpenFolders(string title, string directory = "")
      {
         ...
         if (canOpenFolder)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFolders(string.IsNullOrEmpty(title) ? titleOpenFolders : title, Util.Helper.ValidatePath(directory, true, false), true);
      ...
      public string SaveFile(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canSaveFile)
         {
            ...
            wrapperHolder.PlatformWrapper.SaveFile(string.IsNullOrEmpty(title) ? titleSaveFile : title, Util.Helper.ValidatePath(directory, true, false), string.IsNullOrEmpty(defaultName) ? NameSaveFile : defaultName, extensions);
      ...
      public void OpenSingleFileAsync(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canOpenFile)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFilesAsync(string.IsNullOrEmpty(title) ? titleOpenFile : title, Util.Helper.ValidatePath(directory, true, false), defaultName, false, extensions, setOpenFiles);
         }
         else
         {
      ...
      public void OpenFilesAsync(string title, string directory, string defaultName, bool multiselect = true, params ExtensionFilter[] extensions)
      {
         ...
         if (canOpenFile)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFilesAsync(string.IsNullOrEmpty(title) ? multiselect ? titleOpenFiles : titleOpenFile : title, Util.Helper.ValidatePath(directory, true, false), defaultName, multiselect, extensions, setOpenFiles);
         }
         else
         {
      ...
      public void OpenSingleFolderAsync(string title, string directory = "")
      {
         ...
         if (canOpenFolder)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFoldersAsync(string.IsNullOrEmpty(title) ? titleOpenFolder : title, Util.Helper.ValidatePath(directory, true, false), false, setOpenFolders);
         }
         else
         {
      ...
      public void OpenFoldersAsync(string title, string directory = "", bool multiselect = true)
      {
         ...
         if (canOpenFolder)
         {
            ...
            wrapperHolder.PlatformWrapper.OpenFoldersAsync(string.IsNullOrEmpty(title) ? multiselect ? titleOpenFolders : titleOpenFolder : title, Util.Helper.ValidatePath(directory, true, false), multiselect, setOpenFolders);
         }
         else
         {
      ...
      public void SaveFileAsync(string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (canSaveFile)
         {
            ...
            wrapperHolder.PlatformWrapper.SaveFileAsync(string.IsNullOrEmpty(title) ? titleSaveFile : title, Util.Helper.ValidatePath(directory, true, false), string.IsNullOrEmpty(defaultName) ? NameSaveFile : defaultName, extensions, paths => setSaveFile(paths));
         }
         else
         {
      ...
      public void OpenFilesAsync(System.Action<string[]> cb, string title, string directory, string defaultName, bool multiselect = true, params ExtensionFilter[] extensions)
      {
         ...
         if (cb != null)
         {
            if (canOpenFile)
            {
               ...
               wrapperHolder.PlatformWrapper.OpenFilesAsync(string.IsNullOrEmpty(title) ? titleOpenFiles : title, Util.Helper.ValidatePath(directory, true, false), defaultName, multiselect, extensions, cb);
            }
            else
            {
               Debug.LogWarning("'OpenFilesAsync' is currently not supported for the current platform!", this);
      ...
      public void OpenFoldersAsync(System.Action<string[]> cb, string title, string directory = "", bool multiselect = true)
      {
         ...
         if (cb != null)
         {
            ...
            if (canOpenFolder)
            {
               wrapperHolder.PlatformWrapper.OpenFoldersAsync(string.IsNullOrEmpty(title) ? titleOpenFolders : title, Util.Helper.ValidatePath(directory, true, false), multiselect, cb);
            }
            else
            {
               Debug.LogWarning("'OpenFoldersAsync' is currently not supported for the current platform!", this);
      ...
      public void SaveFileAsync(System.Action<string> cb, string title, string directory, string defaultName, params ExtensionFilter[] extensions)
      {
         ...
         if (cb != null)
         {
            ...
            if (canSaveFile)
            {
               wrapperHolder.PlatformWrapper.SaveFileAsync(string.IsNullOrEmpty(title) ? titleSaveFile : title, Util.Helper.ValidatePath(directory, true, false), string.IsNullOrEmpty(defaultName) ? NameSaveFile : defaultName, extensions, cb);
            }
            else
            {
               Debug.LogWarning("'SaveFileAsync' is currently not supported for the current platform!", this);
