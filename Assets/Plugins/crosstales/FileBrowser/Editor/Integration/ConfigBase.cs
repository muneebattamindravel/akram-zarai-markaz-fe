   ...
   public abstract class ConfigBase : EditorWindow
   {
      ...
      protected void showConfiguration()
      {
         ...
         scrollPosConfig = EditorGUILayout.BeginScrollView(scrollPosConfig, false, false);
         {
            ...
            Util.Config.NATIVE_WINDOWS = EditorGUILayout.Toggle(new GUIContent("Native Inside Editor", $"Enable or disable native file browser inside the Unity Editor under Windows (default: {Util.Constants.DEFAULT_NATIVE_WINDOWS})."), Util.Config.NATIVE_WINDOWS);
